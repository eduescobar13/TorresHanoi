...
class Varilla { // Clase para la implementación de varillas de Las Torres de Hanoi.
    ...
    private: // Atributos privados de la clase.
    	...
    	string nombreVarilla; // Atributo para identificar a cada varilla.
    ...
    public: // Métodos privados de la clase.
        ...
        Varilla(string nombre, int tamanoVarilla, int numeroDiscosInicial); // Constructor.
        ...
        string getNombreVarilla(); // Método getter del atributo nombreVarilla.
		void setNombreVarilla(int nombreVarilla); // Método setter del atributo nombreVarilla.
